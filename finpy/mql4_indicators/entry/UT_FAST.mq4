...
int init()
  {
   for(i = 0; i < 128; i++)
      arr_global_492[i] = 0.0;
   for(i = 0; i < 128; i++)
      arr_global_496[i] = 0.0;
   for(i = 0; i < 11;  i++)
      arr_global_500[i] = 0.0;
   for(i = 0; i < 62;  i++)
      arr_global_504[i] = 0.0;
...
void loadJMA()
  {
   ...
   if(var_120 == 1)
     {
      for(i = 1; i < var_220 + 1; i++)
         arr_global_492[i] = -1000000;
      for(i = var_224; i < 128; i++)
         arr_global_492[i] = 1000000;
      var_120 = 0;
     }
   ...
   var_468 = 1;
   if(Smooth <= 1.0)
      var_380 = 0.0000000001;
   else
      var_380 = (Smooth - 1.0) / 2;
   ...
   var_152 = var_144;
   if((var_144 / MathLog(2.0) + 2.0) < 0.0)
      var_160 = 0;
   else
      var_160 = var_152 / MathLog(2.0) + 2.0;
   var_404 = var_160;
   if((var_404 - 2.0) >= 0.5)
      var_388 = var_404 - 2.0;
   else
   ...
   for(var_124 = bars + 1000; var_124 >= 0; var_124--)
     {
      switch(var_104)
        {
         case 0:
            var_loadJMA_0 = Close[var_124];
            break;
         case 1:
            var_loadJMA_0 = Open[var_124];
            break;
         case 2:
            var_loadJMA_0 = (Open[var_124] + High[var_124] + Low[var_124] + Close[var_124]) / 4;
            break;
         case 3:
            var_loadJMA_0 = High[var_124];
            break;
         case 4:
            var_loadJMA_0 = Low[var_124];
            break;
         default:
            var_loadJMA_0 = Close[var_124];
        }
      ...
      if(var_484 > 30)
        {
         if(var_468 != 0)
           {
            ...
            for(i = 1; i < 30; i++)
              {
               if(arr_global_504[i + 1] != arr_global_504[i])
                  var_212 = 1;
              }
            var_472 = var_212 * 30;
            if(var_472 == 0)
               var_308 = var_loadJMA_0;
            else
               var_308 = arr_global_504[1];
            var_276 = var_308;
            if(var_472 > 29)
               var_472 = 29;
           }
         ...
         for(i = var_472; i >= 0; i--)
           {
            if(i == 0)
               var_260 = var_loadJMA_0;
            else
               var_260 = arr_global_504[31 - i];
            var_292 = var_260 - var_276;
            var_324 = var_260 - var_308;
            if(MathAbs(var_292) > MathAbs(var_324))
               var_152 = MathAbs(var_292);
            else
               var_152 = MathAbs(var_324);
            var_412 = var_152;
            ...
            while(var_252 > 1)
              {
               ...
               if((var_248 == 127) && (var_200 > arr_global_492[127]))
                  var_248 = 128;
              }
            if(var_256 > 127)
              {
            ...
            if(var_244 <= var_248)
              {
               if(var_244 >= var_248)
                 ...
                 {
                  for(var_516 = var_244 + 1; var_516 < var_248; var_516++)
                    {
                     arr_global_492[var_516 - 1] = arr_global_492[var_516];
                    }
              ...
              {
               for(var_520 = var_244 - 1; var_520 >= var_248; var_520--)
                 {
                  arr_global_492[var_520 + 1] = arr_global_492[var_520];
                 }
               arr_global_492[var_248] = var_200;
              }
            if(var_256 <= 127)
              {
               var_192 = 0;
               for(var_528 = var_232; var_528 < var_228 + 1; var_528++)
                  var_192 = var_192 + arr_global_492[var_528];
              }
            ...
            if(var_488 <= 30)
              {
               if(var_292 > 0.0)
                  ...
                  var_276 = var_260 - var_292 * var_396;
               if(var_324 < 0.0)
                  var_308 = var_260;
               else
                  var_308 = var_260 - var_324 * var_396;
               var_436 = var_loadJMA_0;
               if(var_488 != 30)
                  continue;
               var_444 = var_loadJMA_0;
               if(MathCeil(var_372) >= 1.0)
                  var_168 = MathCeil(var_372);
               else
                  var_168 = 1;
               var_480 = var_168;
               if(MathFloor(var_372) >= 1.0)
                  var_152 = MathFloor(var_372);
               else
                  var_152 = 1;
               var_476 = var_152;
               if(var_480 == var_476)
              ...
              {
               if(var_404 >= MathPow(MathAbs(var_412 / var_348),var_388))
                  var_144 = MathPow(MathAbs(var_412 / var_348),var_388);
               else
                  var_144 = var_404;
               if(var_144 < 1.0)
                 {
                 ...
                 {
                  if(var_404 >= MathPow(MathAbs(var_412 / var_348),var_388))
                     var_160 = MathPow(MathAbs(var_412 / var_348),var_388);
                  else
                     var_160 = var_404;
                  var_152 = var_160;
                 }
               ...
               if(var_292 > 0.0)
                  ...
                  var_276 = var_260 - var_292 * var_364;
               if(var_324 < 0.0)
                  var_308 = var_260;
               else
                  var_308 = var_260 - var_324 * var_364;
              }
           }
         if(var_488 > 30)
           {
   ...
   for(var_124 = bars + 30; var_124 >= 0; var_124--)
     {
      ...
      if(inp_lenars_4 == 1)
         ...
         arr_global_556[var_124] = var_128;
     }
   return;
  }
